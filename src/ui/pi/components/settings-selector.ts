...
import { getSelectListTheme, getSettingsListTheme, theme } from "../theme.js";
import { DynamicBorder } from "./dynamic-border.js";
import { keyDisplayText } from "./keybinding-hints.js";
import type { ThinkingLevel } from "./thinking-selector.js";

/** Structural equivalent of pi-ai's `Transport` type. */
export type Transport = "sse" | "websocket" | "websocket-cached" | "auto";

/** Structural equivalent of pi's `WarningSettings` from core/settings-manager.ts. */
export interface WarningSettings {
	anthropicExtraUsage?: boolean; // default: true
}

/** Structural equivalent of pi's `DefaultProjectTrust` from core/settings-manager.ts. */
export type DefaultProjectTrust = "ask" | "always" | "never";

/** Structural equivalent of pi's `TerminalTheme` from theme/theme.ts. */
export type TerminalTheme = "dark" | "light";

/** Structural equivalent of pi's `parseAutoThemeSetting` from theme/theme.ts. */
...
/** Inlined from pi's core/http-dispatcher.ts. */
