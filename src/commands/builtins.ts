...
export const slashCommandDefinitions: SlashCommandDefinition[] = [
  ...
  { name: "/snow", description: "Toggle snowfall or set its intensity", insertText: "/snow ", usage: "/snow [low|medium|hard]" },
  ...
  { name: "/usage", description: "Show accepted agent lines and recorded key usage" },
  { name: "/pin", description: "Pin or unpin the current chat" },
  { name: "/pins", description: "Open pinned chats" },
