...
export type TerminalLayout = "classic" | "focus" | "forge" | "console" | "notebook" | "signal"

const TERMINAL_LAYOUTS = new Set<TerminalLayout>(["classic", "focus", "forge", "console", "notebook", "signal"])
