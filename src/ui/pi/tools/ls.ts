 ...
 *
 * Render-only port of pi's ls tool definition: execute() is omitted;
 * all rendering logic is kept verbatim.
 */
...
export function createLsToolDefinition(_cwd: string): ToolDefinition<LsToolInput, LsToolDetails | undefined> {
	return {
		name: "ls",
		label: "ls",
