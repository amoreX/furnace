 ...
 *
 * Render-only port of pi's bash tool definition: execute() and the local
 * shell-execution backend are omitted; all rendering logic is kept verbatim.
 */
...
export function createBashToolDefinition(
	_cwd: string,
): ToolDefinition<BashToolInput, BashToolDetails | undefined, BashRenderState> {
	return {
		name: "bash",
		label: "bash",
