...
/** Structural equivalent of pi's `AuthStatus` from core/auth-storage.ts. */
...
/** Structural equivalent of pi's `AuthCredential` — only the field this UI reads. */
export type AuthCredential = {
	type: "api_key" | "oauth";
};

/** Structural equivalent of the pi `AuthStorage` surface this component uses. */
