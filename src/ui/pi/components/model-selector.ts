...
/** Structural equivalent of pi-ai's `Model` type — only the fields this UI uses (plus common metadata). */
...
/** Structural equivalent of the pi `ModelRegistry` surface this component uses. */
export interface ModelRegistryLike {
	/** Refresh to pick up any changes to the model catalog. */
	refresh(): void;
	/** Return a catalog load error to display, if any. */
	getError(): string | undefined;
	/** All models available for selection. */
	getAvailable(): Promise<Model[]>;
	/** Find a model by provider and id, if present. */
	find(provider: string, id: string): Model | undefined;
}

/** Structural equivalent of the pi `SettingsManager` surface this component uses. */
export interface ModelSettingsLike {
	setDefaultModelAndProvider(provider: string, modelId: string): void;
}

/** Structural equivalent of pi-ai's `modelsAreEqual`. */
...
export class ModelSelectorComponent extends Container implements Focusable {
	...
	private settingsManager: ModelSettingsLike;
	...
	constructor(
		...
		settingsManager: ModelSettingsLike,
