 ...
 *
 * Render-only port of pi's write tool definition: execute() is omitted;
 * all rendering logic (including incremental syntax highlighting) is kept verbatim.
 */
...
export function createWriteToolDefinition(
	_cwd: string,
): ToolDefinition<{ path?: string; file_path?: string; content?: string }, undefined> {
	return {
		name: "write",
		label: "write",
